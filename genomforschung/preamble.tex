...
\tcbset{my other box/.style={
    ...
    coltitle=white, colbacktitle=rose,
    attach boxed title to top left={xshift=0.3cm,
                                    yshift*=-\tcboxedtitleheight/2},
    boxed title style={
      before upper=\hspace*{0.5cm}, % reserve space for the image
...
\newcommand{\finishedContent}[0]{\textcolor{ForestGreen}{\CheckmarkBold}}
\newcommand{\finishedKlausurfragen}[0]{\textcolor{rose}{\CheckmarkBold}}
\newcommand{\finishedLinking}[0]{\textcolor{Orange}{\CheckmarkBold}}
\newcommand{\finishedKarteikarten}[0]{\textcolor{Yellow}{\CheckmarkBold}}

\newcommand{\todo}[0]{\textbf{\textcolor{red}{TODO - hier muss noch etwas gemacht werden}}}


\newcommand{\transposase}[0]{\index{Transposase}}