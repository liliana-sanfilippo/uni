...
Kommen wir zu einem ``wüsten Beweis'', der \dativepl{regA} zu \glspl{rlinG} in Beziehung setzt (ein äquivalenter Beweis
würde es erlauben, \glspl{llinG} zu \dativepl{regA} in Beziehung zu
