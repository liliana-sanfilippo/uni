...
Das Sternhöhenproblem war tatsächlich bis 1988 noch ungelöst; das ist die Frage, für eine gegebene Sprache einen \gls{regA}
...
Kommen wir zu einem ``wüsten Beweis'', der \glspl{regA} zu \glspl{rlinG} in Beziehung setzt (ein äquivalenter Beweis
würde es erlauben, linkslineare Grammatiken zu regulären Ausdrücken in Beziehung zu
setzen, die Begriffe sind tatsächlich äquivalent):
\begin{satz}
    Eine Sprache L über $\Sigma$ ist regulär dann und nur dann, wenn es eine rechtslineare
    Grammatik G gibt mit $L(G) = L$.
...
Für reguläre Sprachen gelten wichtige strukturelle Eigenschaften:
