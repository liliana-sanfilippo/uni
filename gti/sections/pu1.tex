...
\begin{vorw} $\ $ \\ \newline
\un{Reguläre Ausdrücke} sind spezielle Formeln, die reguläre Sprachen beschreiben könnnen. \\ \newline
\un{Formale Sprachen} sind Sprachen, die durch Regeln formalisiert sind. \\ \newline
\un{Reguläre Sprachen} sind formale Sprachen, die durch endliche Automaten erkannt werden können.  \\ \newline
\un{Rechtslineare Grammatiken} haben Ersetzungsregeln der Form $A ::= \overline{w}B$ oder $A ::= \overline{w}$, wobei $\overline{w}$ ein Terminalsymbol oder meherer Terminalsymbole (ein Wort) sein kann. 
\end{vorw}
