...
\newglossaryentry{dicer}{
    ...
    lange doppelsträngige RNA (\gls{dsrna}) oder \gls{prämirna} in kurze
...
\newglossaryentry{primimrna}{
    ...
    langen \gls{prämirna} prozessiert.},
    type=defi
}
...
\newglossaryentry{mirnaduplex}{
    ...
    das nach \gls{dicer}-Prozessierung der \gls{prämirna} entsteht. Der funktionelle
