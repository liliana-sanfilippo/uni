...
description={Konserviertes Adenosin innerhalb des Introns (Konsensus u.\,a. UACUAAC), dessen 2\textbf{-OH-Gruppe im ersten Schritt des Spleißens das 5\textbf{-Spleißende angreift und so die Lariat-Struktur ausbildet.},
type=defi
}
...
description={Lasso-förmige Struktur des herausgespleißten Introns, entsteht durch eine 5\textbf{{}--2\textbf{-Phosphodiesterbindung zwischen dem 5\textbf{-G des Introns und dem 2\textbf{-OH des Verzweigungs-Adenosins.},
type=defi
}
