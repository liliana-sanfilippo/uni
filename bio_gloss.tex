...
\newglossaryentry{dsrna}{
    name={dsRNA},
    description={Doppelsträngige RNA (\emph{double-stranded RNA}); entsteht
    ...
    (z.\,B.\ Interferon-Signalweg).},
    type=defi
}

\newglossaryentry{endonuklease}{
    name={Endonuklease},
    description={Enzym, das Phosphodiesterbindungen \emph{innerhalb} eines
    Nukleinsäurestrangs spaltet (im Gegensatz zur Exonuklease, die vom
    Ende her abbaut). Beispiele: Restriktionsendonukleasen (sequenzspezifisch),
    RNase~III-Familie (dsRNA-spezifisch, z.\,B.\ Dicer, Drosha),
    AGO2 (RISC-Slicer-Aktivität).},
    type=defi
}
...
\newglossaryentry{lncrna}{
    name={lncRNA},
    description={\emph{Long non-coding RNA}; nicht-kodierende RNA
    ...
    translationaler Ebene. Beispiele: \emph{Xist} (X-Inaktivierung),
    \emph{HOTAIR} (Hox-Genregulation). Häufig zell- und
    entwicklungsstadiumspezifisch exprimiert.},
    type=defi
}
...
\newglossaryentry{primimrna}{
    ...
    \emph{Microprocessor}-Komplex (Drosha\,+\,DGCR8) zur ca.\ 60--70\,nt
...
\newglossaryentry{mirnaduplex}{
    ...
    \emph{Guide}-Strang (\gls{mirna}) wird in \gls{risc} geladen; der komplementäre
    \emph{Passenger}-Strang (\gls{mirna}*, auch miRNA-3p) wird meist degradiert.
...
\newglossaryentry{rnai}{
    ...
    \gls{dicer} in den \gls{risc}-Komplex (\emph{RNA-induced silencing complex})
...
name={Spleißosom},
plural={Spleißosomen},
description={Großer Ribonukleoprotein-Komplex aus \glspl{snrna} und Proteinen, der das Spleißen der \gls{prämrna} katalysiert, indem Introns entfernt und Exons miteinander verknüpft werden.},
type=defi
}
...
name={snRNA},
description={Small nuclear RNA; Bestandteil des Spleißosoms und an der Prozessierung von \gls{prämrna} durch Spleißen beteiligt.},
type=defi
}
...
description={Das unmittelbare Produkt der Transkription eines Gens. Bei eukaryotischen proteincodierenden Genen entspricht es der \gls{prämrna} (hnRNA) und wird durch Prozessierungsschritte wie 5'-Capping, Spleißen und Polyadenylierung zur reifen \gls{mrna} verarbeitet.},
type=defi
}
