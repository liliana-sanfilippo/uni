...
\newglossaryentry{retrotransposon}{
    ...
    description={Ein \gls{transposon}, das über eine RNA-Form mobilisiert; das DNA-Element
...
\newglossaryentry{alu_seq}{
    ...
    \gls{sine}-Familie). Die einzelnen Mitglieder weisen an beiden Enden Alu-Schnittstellen
    auf. (Lewin)},
    type=defi
}
...
\newglossaryentry{line}{
    ...
    description={Eine wichtige Klasse von \gls{retrotransposon}s, die etwa
...
\newglossaryentry{sine}{
    ...
    \gls{retrotransposon}s, die etwa 13 \% des menschlichen
...
description={Regel, nach der Introns fast immer mit GT (im Transkript GU) beginnen und mit AG enden. Auf RNA-Ebene korrekter \enquote{GU-AG-Regel}. Gilt für die \enquote{major}/U2-Typ-Introns (kanonische Spleißstellen, ca.\ 98\,\%).},
type=defi
}

\newglossaryentry{verzweigungsstelle}{
name={Verzweigungsstelle (Branchpoint)},
description={Konserviertes Adenosin innerhalb des Introns (Konsensus u.\,a. UACUAAC), dessen 2\textquotesingle-OH-Gruppe im ersten Schritt des Spleißens das 5\textquotesingle-Spleißende angreift und so die Lariat-Struktur ausbildet.},
type=defi
}
...
description={Lasso-förmige Struktur des herausgespleißten Introns, entsteht durch eine 5\textquotesingle{}--2\textquotesingle-Phosphodiesterbindung zwischen dem 5\textquotesingle-G des Introns und dem 2\textquotesingle-OH des Verzweigungs-Adenosins.},
type=defi
}
...
description={Erkennungsmodus, bei dem die zusammengehörigen Spleißstellen über das (kurze) Intron hinweg definiert werden (\enquote{interactions across the intron}). Typisch für kurze Introns.},
type=defi
}

\newglossaryentry{exondefinition}{
name={Exon-Ekennungsmodus},
description={Erkennungsmodus, bei dem die Spleißfaktoren zunächst über das Exon hinweg interagieren (\enquote{interactions across the exon}) und erst danach zum Intron-überspannenden Komplex umschalten. Wichtig bei langen Introns.},
type=defi
}
...
\newglossaryentry{gruppeiintron}{
name={Gruppe-I-Intron},
plural={Gruppe-I-Introns},
description={Selbst-spleißendes Intron, dessen erster Schritt durch einen externen Guanosin-Cofaktor (3\textquotesingle-OH eines G) eingeleitet wird; bildet kein Lariat.},
type=defi
}

\newglossaryentry{gruppeiiintron}{
name={Gruppe-II-Intron},
plural={Gruppe-II-Introns},
description={Selbst-spleißendes Intron, dessen Mechanismus (2\textquotesingle-OH-Angriff eines internen Adenosins, Lariat-Bildung) dem des nukleären Spleißosoms mechanistisch entspricht.},
type=defi
}
...
description={Post-transkriptionale Änderung der RNA-Sequenz (Basenumwandlung, U-Insertion/-Deletion), sodass die reife mRNA von der genomischen Sequenz abweicht. Häufig in Mitochondrien, Plastiden und Trypanosomen, aber auch in \enquote{normalen} Säugetier-Transkripten.},
type=defi
}
...
description={Humane Erbkrankheit mit Hämoglobin-Mangel. Kann durch Spleiß-Mutationen entstehen, die einen \enquote{falschen Spleißort} aktivieren und so das $\beta$-Globin-Transkript fehlprozessieren.},
type=defi
}
