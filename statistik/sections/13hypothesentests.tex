...
\begin{bsp}
    ...
    Die Studierendenvertreter dagegen wählen $T = \bar X$, weil im Vergleich zwischen $\param=0.2$ (unter $H_0$)
...
\[
    T(x) = \sqrt n\, \frac{\bar x - \wfk_0}{\sigma} \cdot
\]
