...
\begin{satz}
    \textbf{Tschebysche!sche Ungleichung (Spezialfall k = 2)}
    % TODO F 3
    TODO F3 26
\end{satz}

\begin{bsp}
    \textbf{Die Tschebysche!sche Ungleichung kann nicht verbessert werden}
    % TODO F 4-9
    TODO F4-9 26
\end{bsp}
...
\begin{satz}
    ...
    \paragraph{Gegeben} Zufallsvariablen $X_1, X_2, X_3, ...$ auf einem $\wraum$.
