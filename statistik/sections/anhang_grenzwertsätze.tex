...
\section{Zusammenhang Poissonscher Grenzwertsatz, Zentraler Grenzwertsatz, Satz von de Moivre-Laplace und Gesetz der großen Zahlen}\label{subsec:zusammenhang-poissonscher-grenzwertsatz-zentraler-grenzwertsatz-satz-von-de-moivre-laplace-und-gesetz-der-groen-zahlen}
...
Seien $X_1,\dots,X_n$ unabhängige und identisch verteilte Zufallsvariablen mit Erwartungswert $\wfk$.
Dann gilt
...
\subsection*{Zusammenhang zwischen GGZ und ZGWS}
...
\subsection*{Satz von de Moivre-Laplace}
...
\subsection*{Poissonscher Grenzwertsatz}
...
\subsection*{Verhältnis zwischen de Moivre-Laplace und Poissonschem Grenzwertsatz}
