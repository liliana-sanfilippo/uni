...
Zwei Ereignisse A,B sind unabh.  genau dann, wenn die WS der Schnitt auch das produkt der einzelnen WS ist usw. (
siehe Anschnitt aus alten Aufzeichnungen)...
...
\end{beo}
\begin{fr}
    In obigem Beispiel gilt $\pe(A \mid B) > \pe(A)$. Gilt das immer?

    \paragraph{Antwort} Nein! Sowohl $\pe(A_1 \mid B_1) > \pe(A_1)$ als auch $\pe(A_2 \mid B_2) < \pe(A_2)$ sind möglich.
...
\begin{reg}
    ...
    Achtung! Die Abbildung $B \mapsto \pe(A \mid B)$ ist kein Wahrscheinlichkeitsmaß!
