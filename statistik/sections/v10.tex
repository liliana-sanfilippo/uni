...
\begin{er}
   ...
   \end{itemize}
    \txc{
        ...
        $\pe(np-c < S_n \leq np+c) \approx 2\Phi\left(\frac{c}{\sqrt{npq}}\right) - 1$
...
\begin{satz}
    ...
    und es folgt
    \[
        \limnin  \pe \left(  a < \frac{S_n - n \mathcal{M}}{\sqrt{n \sigma^2}} \leq b \right) = \pe \left(  a < \frac{S_n - n p}{\sqrt{n pq}} \leq b \right) = \vfkt(b) - \vfkt(a)
    \]
\end{satz}
