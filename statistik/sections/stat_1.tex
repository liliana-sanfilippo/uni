...
\begin{bsp}\textbf{Ein ganzer Zoo an \gls{Streumaß}en} \txc{(Skript 26)} \\
    ...
    Beweisen Sie als Hausaufgabe, dass es sich jeweils um \gls{Streumaß}e handelt.
\end{bsp}
...
\begin{bsp}\textbf{Das arithmetische Mittel als \gls{Schätzer} im Fall von \gls{Bernoulli-Variable}n} \txc{(Skript 26)} \\
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item Die \gls{Risikofunktion} des \gls{Schätzer}s $t$ ist gegeben durch die Abbildung $\theta\mapsto\dfrac{\theta(1-\theta)}{n}$.
