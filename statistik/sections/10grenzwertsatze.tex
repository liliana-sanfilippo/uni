...
\begin{er}
    ...
    \[
        \lim_{n \rightarrow \infty} \pe \big\left( a < \frac{\sn - np}{\sqrt{npq}} \leq b \big\right) = \frac{1}{\sqrt{2 \pi}} \intab e^{-x^{2} / 2} dx
    \]
   ...
   \begin{itemize}
       ...
       n ab)}
       \item Ist $ 0 < c \ll \sqrt{n}$ , so geht die Ws. mit $n \rightarrow \infty$ immer noch gegen Null
...
\section{Vergleich Gesetz der großen Zahlen vs. Zentraler Grenzwertsatz}\label{sec:vergleich-gesetz-der-groen-zahlen-vs.-zentraler-grenzwertsatz}
...
\section{Zentraler Grenzwertsatz}\label{sec:zentraler-grenzwertsatz}
...
\begin{satz}
    ...
    Sind die Zufallsvariablen $X_1, X_2, X_3, \dots$ unabhängige Bernoulli-Variablen, so
...
\section{Poissonscher Grenzwertsatz}\label{sec:poissonscher-grenzwertsatz}
...
\begin{bsp}
    ...
    \[
        \left[0, t) = \bigcup_{k=1}^N \left[  \frac{k-1}{N} \cdot t, \frac{k}{N} \cdot t \right)
    \right]
    ...
    eintrifft.
    Die Erfolgsws.
    dieser Bernoulli-Variable ist $\alpha t / N$
    ...
    \]
    (Beachten Sie, daß wir in diesem Problem N beliebig groß machen dürfen.
    Wir verwenden
