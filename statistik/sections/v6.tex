...
\begin{kor}
    ...
    $X_1, .., X_n$ unabhängig $\Leftrightarrow$ gemeinsame Verteilung eindeutig bestimmt durch (Rand-)Verteilungen von
    $X_1, .., X_n$ \\
    Aka.:
    \[
        X_1, \dots, X_n  \text{ unabhängig } \Rightarrow \text{ gemeinsame Verteilung von } X_1, \dots, X_n \text{ eindeutig bestimmt durch die Randverteilung}
    \]
\end{kor}
...
\begin{bem}
    ...
    \txc{Umkehridee:} \\
    \textbf{(b)} Gegeben
    Verteilung der $X_i$: Wir nutzen die Produktform, um die gemeinsame Verteilung für unabhängig $X_i$
...
\end{bem}
% Tafel:
%$X_1, .., X_n$ mit Dichten, Unabhängigkeit
%dann
%\[
%    \pe(X_1 \in a_1, X_n \in a_n) = siehe bild (aber das zweite)
%\]
...
\begin{satz}
    ...
    Seien $X_1, \dots, X_n$ unabhängig $ \Leftrightarrow \pe(X_1 \leq a_1, \dots, X_n \leq a_n) = \pe(X_1 \leq a_1) \cdot \dots \cdot  \pe(X_n \leq a_n) = \mathcal{F}_{x_1}(a_1) \cdot \dots \cdot \mathcal{F}_{x_n}(a_n) \forall a_1, \dots, a_n \in \mathbb{R}$.
...
\begin{satz}
    ...
    Dann gilt:
    $X_1, \dots, X_n$ unabhängig $\Leftrightarrow$ gemeinsame \dichte hat Produktform $\Leftrightarrow$ $(x_1, \dots, x_n) \mapsto f((x_1, \dots, x_n)) \coloneqq  f_1(x_1)\cdot \dots \cdot f_n(x_n)$ eine gemeinsame Sichte von $X_1, \dots, X_n$ ist.
\end{satz}
...
\begin{bem}
    ...
    Es genügt nicht einen Punkt zu finden, in dem~\eqref{eq:gemdichte} nicht gilt.
