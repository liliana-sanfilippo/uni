...
\begin{bsp}[Exponentialverteilte \gls{zv}n]
    ...
    \begin{itemize}
        ...
        \[
            \fxx(x) = \fxx(0) + \int_{0}^{x} \alpha e^{-\alpha u} du
            = \int_{0}^{x} \alpha e^{-\alpha u} du.
        \]
        Der Integrand $h(u) = \alpha e^{-\alpha u}$ besitzt die Stammfunktion
        $H(u) = -e^{-\alpha u}$.
        Daher folgt
        \[
            \fxx(x) = H(u)\big|_{u=0}^{x} = 1 - e^{-\alpha x}.
        \]
    \end{itemize}
    Somit gilt
    \[
...
\begin{bsp}[Robin und Uli würfeln \dots]
    ...
    \[
        ...
        \begin{array}{c|cccc|c}
            \wfk_Z((x,y)) & y = 0 & y = 1 & y = 2 & y = 3 & \wfk_X(x) \\ \hline
            ...
            \wfk_Y(y) & \bigl(\tfrac56\bigr)^3 & 3\,\tfrac16\bigl(\tfrac56\bigr)^2
...
\begin{lem}[Bestimmen von Randverteilungen für \gls{zv}n mit abzählbarem Bildbereich]
    ...
    \[
        ...
        \wfk_X(u_1, \dots, u_{k-1}, x, u_{k+1}, \dots, u_n) \qquad \forall\, x \in E_k.
    \]
    \begin{proof}
        ...
        \[
            \wfk_Y(y) = \pe(\zvy = y) = \pe(\zvx \in E_1, \zvy = y, \zvy \in E_3)
            = \sum_{x \in E_1} \sum_{z \in E_3} \wfk_X(x,y,z) \qquad \forall\, y \in E_2 ,
        \]
        also gilt $\wfk_Y(y) = \sum_{x \in E_1} \sum_{z \in E_3} \wfk_X(x,y,z)$ für alle
        $y \in E_2$.
    \end{proof}
\end{lem}
...
\begin{lem}[Berechnen von Randdichten]\label{lem:berechnen-randdichten}
    ...
    \begin{proof}
        ...
        \[
            ...
            \right) dx = \int_{-\infty}^{a} f_X(x) dx
        \]
        mit $f_X(x) = \int_{-\infty}^{\infty} f(x,y) dy$.
