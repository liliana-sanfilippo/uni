...
\begin{bem}
    ...
    \end{itemize}
    Die folgende Rechnung zeigt sowohl die Existenz des uneigentlichen Riemann-
    Integrals über $\rz$ als auch, daß die Normierungsbedingung erfüllt ist.
    \begin{align*}
        ...
        & = 1
    \end{align*}
    % TODO da könnte man noch was aus dem 2026 skript hinzufügen, alternative rechnung
\end{bem}
...
\karkarfor{def_vereinigung_schnitt_abzaehlbar}
...
\karkarfor{bsp_disjunkt_nicht_paarweise_Ak}
...
\karkarfor{satz_einschluss_ausschluss_n}
