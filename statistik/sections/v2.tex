...
\begin{lem}
    ...
    Seien $\erga,\ergb,C \subset \eraum $.
    \begin{figure}[H]
        \centering
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \end{tikzpicture}
            \caption{Transitivität: $\erga\subset \ergb, \quad \ergb \subset C \Rightarrow \erga \subset C$}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            \end{tikzpicture}
            \caption{Distributivgesetz: $\erga \cap (\ergb \cup C) = (\erga \cap \ergb) \cup (\erga \cap C)$ und
                $ \erga \cup (\ergb \cap C) = (\erga \cup \ergb) \cap (\erga \cup C)$}
    ...
    \begin{itemize}
        ...
        \item Assoziativgesetz:$(\erga \cup \ergb) \cup C = \erga \cup (\ergb \cup C) $ und $(\erga \cap \ergb) \cap C = \erga \cap (\ergb \cap C) $
...
\begin{bem}  \txc{(2025)} \\
    ...
    Sind $\erga, \ergb, C$ paarweise disjunkt, so gilt nach (a): $\pe(\erga \cup \ergb \cup C) \overset{(a)}{=} \pe(\erga) + \pe(\ergb) + \pe(C) $. \\ \\
    Was passiert, wenn $\erga,\ergb,C$ nicht paarweise disjunkt sind? \begin{align*}
                                                                  \pe(\erga \cup \ergb \cup C) & = \pe(\erga \cup (\ergb \cup C)) \\
                                                                  & = \pe(\erga) \pe( \cup \ergb \cup C) -  \pe(\erga \cap (\ergb \cup C)) \\
                                                                  & = \pe(\erga) + [\pe(\ergb) + \pe(C) - \pe(\ergb \cap C)] - \pe((\erga \cap \ergb) \cup (\erga \cap C))\\
                                                                  & = \pe(\erga) + \pe(\ergb) + \pe(C)  & \text{Mengen }  \\
                                                                  & \quad - \pe(\erga \cap \ergb) - \pe(\erga \cap C) - \pe(\ergb \cap C) & \text{Paare von Mengen }  \\
                                                                  & \quad + \pe(
                                                                  \txo{
                                                                      \underbrace{
                                                                          \textcolor{black}{(\erga \cap \ergb) \cap (\erga \cap C)}
                                                                      }_{= \erga \cap \ergb \cap C}
                                                                  }
