...
\begin{defi}
    \textbf{Wahrscheinlichkeitsräume mit Dichten}\label{defi:wr_dichte} \txc{(2025, Skript 26 - Definition 1.25)} \\
...
\begin{defi}
    \textbf{Exponentialverteilung} \label{defi:exponentialverteilung} \txc{(2025, Skript 26 - Definition 1.36)}\\
