...
\begin{auf}[(c) Die Zufallsvariable $G:\Omega\to\mathbb R$ bezeichne Ihren Gewinn, sollten Sie eine Runde spielen. Dabei sei $G$ negativ, falls Sie Geld verlieren. Definieren Sie diese Zufallsvariable mit Hilfe der Zufallsvariablen $M$ und $N$, und geben Sie den Bildbereich $G(\Omega)$ an.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{images/lösungen/wts211c}\label{fig:figure29}
    \end{figure}
\end{auf}
...
\begin{auf}[(d) Berechnen Sie den erwarteten Gewinn, d.\,h.\ den Erwartungswert von $G$.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{images/lösungen/wts211d}\label{fig:figure28}
    \end{figure}
\end{auf}
...
\begin{auf}[(e)  Ist das Spiel fair, das heißt, beträgt der erwartete Gewinn 0 Euro?]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\linewidth]{images/lösungen/wts211e}\label{fig:figure27}
    \end{figure}
\end{auf}



\subsection{HA 2.1.2 \abhaken}\label{subsec:ha-2.1.2}
...
\begin{auf}[(a) Bestimmen Sie $c$ derart, dass $f$ eine zweidimensionale Dichte ist.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts212a}
    \end{figure}
\end{auf}
...
\begin{auf}[(b) Berechnen Sie Erwartungswert und Varianz von $X$ und $Y$. Warum existieren diese?]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts212b-2}
    \end{figure}
    Oder:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{images/lösungen/wts212b_1}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{images/lösungen/wts212b_2}
    \end{figure}
\end{auf}
...
\begin{auf}[(c) Berechnen Sie den Erwartungswert von $2X-Y$. Warum existiert dieser?]
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts212c}
    \end{figure}
    Oder:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts212c-2}
    \end{figure}
\end{auf}

\subsection{HA 2.1.3 \teils}\label{subsec:ha-2.1.3}
