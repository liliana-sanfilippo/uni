...
\subsection{HA 2.4.1 (fast)}\label{subsec:ha-2.4.1}
...
\subsection{HA 2.4.3}\label{subsec:ha-2.4.3}
...
\begin{auf}[(c) Begründen Sie, warum auch $t_2$ mit $t_2(x)=\sqrt{x_1\cdot x_2}$ für alle $x\in\mathcal X$ ein Schätzer für $\theta$ ist.]
    ...
    \end{figure}
\end{auf}
Beachten Sie, dass im Kontext der Aufgabe $\sqrt{x_1\cdot x_2}=x_1\cdot x_2=(x_1\cdot x_2)^2$ genutzt werden kann, da nur $x_1,x_2\in\{0,1\}$ auftreten. Dies vereinfacht die Berechnungen.
