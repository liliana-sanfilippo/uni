%! Author = lili
%! Date = 8/12/26
\section{Abgabe 1.4 \abhaken}\label{sec:abgabe-1.4}

\subsection{HA 1.4.1 \abhaken}\label{subsec:ha-1.4.1}
...
\begin{auf}[(a) Die Ereignisse $A,B,C,D\subseteq\Omega$ seien unabhängig. Beweisen Sie:]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts141a}
    \end{figure}
\end{auf}
...
\begin{auf}[(c) Geben Sie ein Beispiel an, das zeigt, dass $A,B$ und $C$ nicht unabhängig sein müssen.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{images/lösungen/wts141c}
    \end{figure}
...
\begin{auf}[(d) Geben Sie die Werte für die Wahrscheinlichkeit, dass René mindestens die Note 2,3 erreicht, explizit an für $K=5$, $K=10$ und $K=20$.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth, angle=90]{images/lösungen/wts143d-2}
    \end{figure}
\end{auf}