...
\begin{auf}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $X = (X_1, ..., X_n)$ mit $\{X_i\}^n_{i=1}$ unabhängig identisch verteilt
            \item $X_i \sim Ber()$
        \end{itemize}
    \end{itemize}
    ...
    \begin{align*}
        \sumEN X_i \sim Bin(n, \frac{3}{10}) & = Bin_{200, \frac{3}{10}}(\{0, ..., 45\}) \\
...
\section{PÜ 2.6.5}
Beantworten Sie die folgenden Fragen zur Theorie der Hypothesentests. Eine Begründung Ihrer
