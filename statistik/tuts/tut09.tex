...
\subsection{PÜ 2.2.4. (Lösung da, noch nicht eingetragen)}\label{sec:pu-2.2.4.}
% TODO Bilder Nils
...
\subsection{PÜ 2.2.5. (Lösung da, noch nicht eingetragen)}\label{sec:pu-2.2.5}
% TODO Bilder Nils
...
\subsection{PÜ 2.2.6. (Lösung da, noch nicht eingetragen)}
% TODO Bilder Nils
...
%\subsection{Besprechung ÜB 2.1.1}\label{sec:besprechung-ub-2.1.1}
...
%\subsection{Besprechung ÜB 2.1.2}\label{sec:besprechung-ub-2.1.2}
...
%\begin{auf}
%    \subsubsection*{(a) Bestimmen Sie c derart, daß f eine \gls{zweidimensionaledichte} ist}
%\end{auf}
...
%\subsection{Besprechung ÜB 2.1.3}\label{sec:besprechung-ub-2.1.3}
%\begin{auf}
%    \subsubsection*{(a)}
%\end{auf}
%\begin{auf}
