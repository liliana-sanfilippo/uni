...
\section{Tutorium 27.04.2026}\label{ch:tutorium-27.04.2026}
\untit{Präsenzaufgaben 1.2: Dichten \hfill 27.--30.\ April 2026}


\subsection{PÜ 1.2.4 \abhaken}\label{sec:pu-1.2.4}
...
\begin{auf}[(a) Bestimmen Sie ein $c \in \rz$ derart, dass $f$ eine Dichte ist]
    \textbf{Lösung:} $f(x)$ ist eine Dichte, wenn $\int_{\rz}  f(x) \dx = 1$ also $\int_{-\infty}^{\infty}  f(x) \dx = 1$ % TODO tag einbauen?
