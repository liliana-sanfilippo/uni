...
\section{Tutorium 20.04.2026}\label{sec:tutorium-20.04.2026}
\untit{Präsenzaufgaben 1.1: Wahrscheinlichkeitsräume \hfill 20.--24.\ April 2026}
\index{Aufgabe!Ereignisräume wählen}
\subsection{PÜ 1.1.4 - Faire Münze 3-mal Werfen}\label{sec:pu-1.1.4}
...
Wahrscheinlichkeitsfunktion $\wfk$ an. Begründen Sie Ihre Wahl.]
    \index{Aufgabe!Wahrscheinlichkeitsfunktion wählen}
    NOCH KEINE LÖSUNG % TODO NOCH KEINE LÖSUNG
\end{auf}
...
\subsection{PÜ 1.1.5 - Faire Münze n-mal Werfen (Zusatzaufgabe für die Flinken)}\label{sec:pu-1.1.5}
...
\subsection{PÜ 1.1.6 - Mensch ärgere dich nicht (Zusatzaufgabe für die Flinken)}\label{sec:pu-1.1.6}
