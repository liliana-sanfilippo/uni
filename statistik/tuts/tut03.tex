...
\begin{auf}
    ...
    \]
    \[
        mu = ? \squiggarrow \pe(A) = \sum_{\elem \in A} mu(\elem)
    \]
    Für $1 \leq \elem \leq 6:$: $mu_1 \sim \cup_{\{1,...,6\}} $

    $mu(\elem) = mu_1(\elem) = \frac{1}{6} \quad \forall \elem \in \{1,...,5\}$

    $mu(6) = 0$

    Für $7 \leq \elem \leq 12:$: $mu_2 \sim \cup_{\{1,...,6\}^2} $

    $mu(\elem) = mu_2((6,6-\elem)) = \frac{1}{36} \quad \forall \elem \in \{7,...,11\}$
