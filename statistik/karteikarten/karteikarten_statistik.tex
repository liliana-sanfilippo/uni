...
\newglossaryentry{def_merkmal_stat}{
    ...
    description={Eine Eigenschaft, die an einer Versuchseinheit erhoben bzw.\ gemessen wird (z.B.\ Lage, Farbe, Alter, Größe).
    Ein Merkmal tritt in verschiedenen Ausprägungen auf.},
    type=dinge
}
...
\newglossaryentry{def_arten_von_merkmalen_1}{
    ...
    description={Diskret (z.B.\ Alter in Jahren) und stetig (z.B.\ Größe).},
    type=dinge
}

\newglossaryentry{def_arten_von_merkmalen_2}{
    name={Welche Arten von qualitativen Merkmalen unterscheidet man?},
    description={In ordinale Merkmale/Rangmerkmale mit natürlicher Ordnung (z.B.\ untergewichtig/normal/übergewichtig) und nominale Merkmale ohne natürliche Ordnung (z.B.\ Farbe).},
    type=dinge
}
...
name={Wie ist die Spannweite einer Stichprobe formal definiert?},
description={Spannweite $= x_{\max}-x_{\min} = x_{(n)}-x_{(1)}$.},
type=dinge
}

\newglossaryentry{def_spannweite_1}{
name={Ist die Spannweite einer Stichprobe robust gegenüber Ausreißern?},
description={Sie ist ein Streumaß, aber NICHT robust gegenüber Ausreißern.},
type=dinge
}

\newglossaryentry{def_medianabweichung}{
name={Wie ist die Medianabweichung formal definiert?},
description={Man bildet die Hilfsstichprobe $y_i=|x_i-x_{\mathrm{med}}|$; die Medianabweichung ist der Median $y_{\mathrm{med}}$ dieser Hilfsstichprobe ("Median der absoluten Abweichungen vom Median").},
type=dinge
}

\newglossaryentry{def_medianabweichung_1}{
name={Ist die Medianabweichung robust gegenüber Ausreißern?},
description={Ha, sie ist robust gegenüber Ausreißern.},
type=dinge
}

\newglossaryentry{def_mittlere_absolute_abweichung_vom_median}{
name={Wie ist die mittlere absolute Abweichung vom Median formal definiert?},
description={$\bar s = \dfrac1n\sum_{i=1}^n |x_i-x_{\mathrm{med}}|$ (arithmetisches Mittel der Hilfsstichprobe $y_i=|x_i-x_{\mathrm{med}}|$).},
type=dinge
}

\newglossaryentry{def_mittlere_absolute_abweichung_vom_median_1}{
name={Ist die mittlere absolute Abweichung vom Median robust?},
description={Nein, sie ist NICHT robust gegenüber Ausreißern - obwohl der Median selbst robust ist.},
type=dinge
}

\newglossaryentry{def_mittlere_absolute_abweichung_vom_mittel}{
name={Wie ist die mittlere absolute Abweichung vom arithmetischen Mittel formal definiert?},
description={$\dfrac1n\sum_{i=1}^n |x_i-\bar x|$.},
type=dinge
}

\newglossaryentry{def_mittlere_absolute_abweichung_vom_mittel_1}{
name={Ist die mittlere absolute Abweichung vom arithmetischen Mittel robust?},
description={Nein, sie ist NICHT robust gegenüber Ausreißern.},
type=dinge
}

\newglossaryentry{def_stichprobenvarianz}{
name={Wie ist die (Stichproben-)Varianz $s^2$ definiert?},
description={$s^2 = \dfrac1n\sum_{i=1}^n (x_i-\bar x)^2$ -- die mittlere quadratische Abweichung vom arithmetischen Mittel.},
type=dinge
}
\newglossaryentry{def_stichprobenvarianz_1}{
name={Ist die (Stichproben-)Varianz $s^2$ robust gegenüber Ausreißern?},
description={nein, sie ist NICHT robust gegenüber Ausreißern.},
type=dinge
}
...
name={Wie lässt sich $\bar s$ (mittlere absolute Abweichung vom Median) mithilfe der
Häufigkeitsverteilung statt der Rohdaten berechnen?},
description={$\bar s = \dfrac1n\sum_{k=1}^s |a_k-x_{\mathrm{med}}|\,H_n(a_k) = \sum_{k=1}^s |a_k-x_{\mathrm{med}}|\,h_n(a_k)$ - man summiert über die $s$ verschiedenen Ausprägungen statt über alle $n$ Beobachtungen.},
type=dinge
}

\newglossaryentry{satz_streumasse_via_haeufigkeitsverteilung_1}{
name={Wie lässt sich $s^2$ (Varianz) mithilfe der
Häufigkeitsverteilung statt der Rohdaten berechnen?},
description={$s^2 = \dfrac1n\sum_{k=1}^s (a_k-\bar x)^2\,H_n(a_k) = \sum_{k=1}^s (a_k-\bar x)^2\,h_n(a_k)$ -- man summiert über die $s$ verschiedenen Ausprägungen statt über alle $n$ Beobachtungen.},
type=dinge
}
...
description={Für $p\in(0,\tfrac12)$ ist der $p$-Quantilsabstand definiert als $x_{1-p}-x_p$.},
type=dinge
}

\newglossaryentry{def_p_quantilsabstand_1}{
name={Wie heißt der Spezialfall $p=1/4$ des $p$-Quantilsabstands?},
description={Der Fall $p=1/4$ heißt Quartilsabstand.},
type=dinge
}
...
% ===================================================================
% Zusatzkarten: Übersichten
% ===================================================================

\newglossaryentry{bem_uebersicht_robuste_streumasse}{
name={Welche der behandelten Streumaße sind robust gegenüber Ausreißern?},
description={Robust: Medianabweichung, $p$-Quantilsabstand. NICHT robust: Spannweite, mittlere absolute Abweichung vom Median, mittlere absolute Abweichung vom arithmetischen Mittel, (Stichproben-)Varianz, (Stichproben-)Standardabweichung.},
type=dinge
}

\newglossaryentry{bem_uebersicht_lagemasse}{
name={Welche Lagemaße wurden behandelt?},
description={Arithmetisches Mittel, Modalwert (Modus), Median (Zentralwert) und empirisches $p$-Quantil (der Median ist der Spezialfall $x_{1/2}$ des $p$-Quantils).},
type=dinge
}

% ===================================================================
% Zusatzkarten: Umgangssprachliche Definitionen
% ===================================================================

\newglossaryentry{bem_umgangssprachlich_medianabweichung}{
name={Wie kann man die Medianabweichung umgangssprachlich beschreiben?},
description={Der "typische" Abstand eines Datenpunkts vom Median: Man schaut sich an, wie weit jeder Wert vom Median entfernt ist, und nimmt davon wiederum den Median.},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_mittlere_abweichung_median}{
name={Wie kann man die mittlere absolute Abweichung vom Median umgangssprachlich beschreiben?},
description={Die durchschnittliche Entfernung der Datenpunkte vom Median, ohne Berücksichtigung der Richtung (des Vorzeichens) der Abweichung.},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_mittlere_abweichung_mittel}{
name={Wie kann man die mittlere absolute Abweichung vom arithmetischen Mittel umgangssprachlich beschreiben?},
description={Die durchschnittliche Entfernung der Datenpunkte vom arithmetischen Mittel, ohne Berücksichtigung der Richtung (des Vorzeichens) der Abweichung.},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_stichprobenvarianz}{
name={Wie kann man die (Stichproben-)Varianz umgangssprachlich beschreiben?},
description={Ein Maß dafür, wie stark die Daten im Schnitt um das arithmetische Mittel streuen, wobei größere Abweichungen durch das Quadrieren überproportional stark ins Gewicht fallen.},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_standardabweichung}{
name={Wie kann man die (Stichproben-)Standardabweichung umgangssprachlich beschreiben?},
description={Die "typische" Streuung der Daten um das arithmetische Mittel, gemessen in derselben Einheit wie die ursprünglichen Daten (im Gegensatz zur Varianz, die in quadrierten Einheiten gemessen wird).},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_p_quantil}{
name={Wie kann man das $p$-Quantil umgangssprachlich beschreiben?},
description={Der Wert, bis zu dem ungefähr $100p\,\%$ der Daten liegen -- eine Verallgemeinerung des Medians (der genau das $50\%$-Quantil ist) auf beliebige Anteile.},
type=dinge
}

\newglossaryentry{bem_umgangssprachlich_p_quantilsabstand}{
name={Wie kann man den $p$-Quantilsabstand umgangssprachlich beschreiben?},
description={Die Breite des "mittleren" Bereichs der Daten zwischen dem unteren und dem oberen Quantil ($x_p$ bis $x_{1-p}$): je kleiner $p$, desto mehr der (mittleren) Daten wird erfasst, und je größer dieser Abstand, desto stärker streuen die Daten.},
type=dinge
}
