...
\newglossaryentry{bem_zusammenhang_unabhaengigkeit_bedingte_ws}{
    ...
    description={$P(A\mid B)=P(A)$ (wenn $P(B)>0$) oder $P(A\cap B)=P(A)\cdot P(B)$.},
    type=dinge
}
...
\newglossaryentry{reg_multiplikationssatz_zwei_ereignisse}{
    name={$P(A\cap B) =$},
    description={$P(A\mid B)\,P(B)$ für alle $A,B\subseteq\Omega$},
    type=dinge
}
...
\newglossaryentry{def_formel_totale_wahrscheinlichkeit}{
    ...
    description={$P(A) = \sum_i P(A\mid B_i)\,P(B_i)$},
    type=dinge
}
...
\newglossaryentry{satz_bayes_einfache_version}{
    ...
    description={$P(A\mid B) = P(B\mid A)\cdot\dfrac{P(A)}{P(B)}$},
    type=dinge
}
...
\newglossaryentry{satz_bayes_allgemeine_version}{
    ...
    description={$P(B_i\mid A) = \dfrac{P(A\mid B_i)\,P(B_i)}{\sum_j P(A\mid B_j)\,P(B_j)}$.},
    type=dinge
}
