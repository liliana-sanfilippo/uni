...
% Achtung: Diese Notation setzt voraus, dass klar ist, auf welche Referenz-Obermenge $\Omega$ man sich bezieht.
\newglossaryentry{def_komplement}{
    name={Wie ist das Komplement $A^c$ einer Menge $A\subseteq\Omega$ definiert?},
description={$A^c := \Omega \setminus A$},
type=dinge
}
...
name={Gilt disjunkt $\Rightarrow$ paarweise disjunkt?},
...
description={$P\left(\dot\bigcup_i A_i\right) = \sum_i P(A_i)$, für paarweise disjunkte $A_1,A_2,\dots$. Gilt auch
bei durch Dichten gegebenem $P$},
type=dinge
}