...
E. coli werden hat ca. 4100 Gene. Natürlich werden
...
\section{Ebenen der Genregulation}
\begin{figure}
    % TODO F 8 + 9
    \caption{Verschiedene Ebenen der Regulation}
\end{figure}
...
\subsection{Genregulation durch alternative Sigma-Faktoren}
\defin{sigma_faktor}
\paragraph{Rolle des sigma-Faktors bei der Promotererkennung} % TODO F 10 
% TODO F 11-12
\subsection{Regulation der Transkriptionsinitiation in Bakterien}
\begin{table}[H]
    \centering
    \begin{tabular}{p{2cm} p{5cm} p{5cm}}
    \end{tabular}
