...
\begin{figure}[H]
    % TODO Schmelzkurve \includegraphics[width=\textwidth]{bilder/basen}
    \caption{Die Schmelzkurve der DNA}\label{fig:figure8}
\end{figure}
...
\begin{figure}[H]
    % TODO F26 \includegraphics[width=\textwidth]{bilder/basen}
