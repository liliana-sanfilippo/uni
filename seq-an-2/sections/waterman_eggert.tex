...
Quellen: \cite{smithwaterman_dundee, wiki_needlemanwunsch, smithwaterman_freiburg}

\komm{WARNUNG: man kann zwar bei eggert das erste Aligment nicht mehr nehmen, aber es könnte dort trtzdem noch ein Indel sein.
}
