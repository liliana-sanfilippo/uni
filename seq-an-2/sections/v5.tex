...
Let $\glssymbol{frequency_vector} = (\pi_a)_{a\in\Sigma}$ be the frequency vector, which means that $\pi_a\ge 0$ for all
...
themselves, but also on the position $i$ within the query sequence $x$. \cite{seqan_skript}
