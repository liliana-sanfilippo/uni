...
Also
\begin{enumerate}
    \item Ein Match bekommt einen positiven Score und eine Lücke einen negativen
    \item Mismatch-Scores sind kleiner als Match-Scores
    \item Scores sind immer Symmetrisch
    \item Substitution bekommt besseren Score als erst Deletion und dann Insertion
\end{enumerate}
}
