...
\subsubsection*{Iteration 2 and 3} were taken from \cite{nussinov_freiburg} (with Minimal loop length l = 1 and Delta \#bp to maximum = 0).
Resulting in:
%and checked with \url{https://iba-amrt.vlabs.ac.in/exp/rna-nussinov/simulation/index.html}.
