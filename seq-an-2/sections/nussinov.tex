    ...
    \begin{subfigure}[t]{0.65\textwidth}
        \scriptsize \[
                        T =     \begin{tabular}{|c|c|c|c|c|c|c|}
                                    ...
                                    4     &       &       &       &       &       &       \\
                                    5     &       &       &       &       &       &       \\
                                    6 & \textcolor{white}{unpaired} & \textcolor{white}{unpaired} & \textcolor{white}{unpaired}
                                    & \textcolor{white}{unpaired}
                                    & \textcolor{white}{unpaired}
                                    & \textcolor{white}{init}
                                    \\ \hline
                        \end{tabular}
    ...
    \begin{subfigure}[t]{0.65\textwidth}
        ...
        \[
            T =     \begin{tabular}{|c|c|c|c|c|c|c|}
                        ...
                        1     & unpaired                  & init     &          &          &          &       \\
                        2     & unpaired                  & unpaired & init     &          &          &       \\
                        3     & \textcolor{red}{unpaired} & unpaired & unpaired & init     &          &       \\
                        4     &                           &          & unpaired & unpaired & init     &       \\
                        5     &                           &          &          & unpaired & unpaired & init  \\
                        6 & \textcolor{white}{unpaired} & \textcolor{white}{unpaired} & \textcolor{white}{unpaired}
                        &
    ...
    \begin{subfigure}[t]{0.65\textwidth}
        ...
        \[
            T =     \begin{tabular}{|c|c|c|c|c|c|c|}
                        ...
                        1     & unpaired & init                    &          &          &          &       \\
                        2     & unpaired & unpaired                & init     &          &          &       \\
                        3     & case 3   & unpaired                & unpaired & init     &          &       \\
...
\url{https://rna.informatik.uni-freiburg.de/Teaching/index.jsp?toolName=Nussinov} (with Minimal loop length l = 1 and Delta \#bp to maximum = 0). %and checked with \url{https://iba-amrt.vlabs.ac.in/exp/rna-nussinov/simulation/index.html}.
Resulting in:
    ...
    \begin{subfigure}[t]{0.25\textwidth}
        ...
        \[
            M =  \begin{tabular}{|c|c|c|c|c|c|c|}
                     ...
                     2     & 0                  & 0                  & 0                  &       &       &       \\
                     3     & 1                  & 0                  & 0                  & 0     &       &       \\
                     4     & \textcolor{red}{1} & 1                  & 0                  & 0     & 0     &       \\
                     5     & \textcolor{red}{2} & \textcolor{red}{1} & 0                  & 0     & 0     & 0     \\
                     6     &                    & \textcolor{red}{1} & \textcolor{red}{1} & 0     & 0     &       \\ \hline
            \end{tabular}
        \]
        \caption{ Compute $M(4,6)$ according to the recurrence}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.65\textwidth}
        ...
        \[
            T =     \begin{tabular}{|c|c|c|c|c|c|c|}
                        ...
                        4     & --                          & case 3   & unpaired & unpaired & init     &                         \\
                        5     & --                          & --       & case 1-3 & unpaired & unpaired & init                    \\
                        6     & \textcolor{white}{unpaired} & --       & --       & case 1-3 & unpaired & \textcolor{white}{init} \\ \hline
            \end{tabular}
        \]
        \caption{$T(4,6) \gets \text{case}$ }
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.25\textwidth}
        ...
        \[
            M =  \begin{tabular}{|c|c|c|c|c|c|c|}
                     ...
                     4     & 1                  & 1     & 0     & 0     & 0     &       \\
                     5     & 2                  & 1     & 0     & 0     & 0     & 0     \\
                     6     & \textcolor{red}{2} & 1     & 1     & 0     & 0     &       \\ \hline
            \end{tabular}
        \]
        \caption{ Compute $M(4,6)$ according to the recurrence}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.65\textwidth}
        ...
        \[
            T =     \begin{tabular}{|c|c|c|c|c|c|c|}
                        ...
                        4     & --                      & case 3   & unpaired & unpaired & init     &                         \\
                        5     & --                      & --       & case 1-3 & unpaired & unpaired & init                    \\
                        6     & \textcolor{red}{case 3} & --       & --       & case 1-3 & unpaired & \textcolor{white}{init} \\ \hline
            \end{tabular}
        \]
        \caption{$T(4,6) \gets \text{case}$ }
    \end{subfigure}
