...
\begin{bsp}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.4\linewidth]{images/hirschberg_CACG_GAG_schritt_3}

        \includegraphics[width=0.4\linewidth]{images/hirschberg_CACG_GAG_schritt_4}

        \includegraphics[width=0.4\linewidth]{images/hirschberg_CACG_GAG_schritt_5}

        \caption{}\label{fig:hirschberg_CACG_GAG}
    \end{figure}
\end{bsp}