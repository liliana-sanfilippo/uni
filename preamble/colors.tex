...
\titleformat{\section}{\sffamily\color{rose}\Large\bfseries}{\thesection\enskip\color{gray}\textbar\enskip}{0cm}{} %


\titleformat{\subsection}{\sffamily\color{rose}\large\bfseries}{\thesubsection\enskip\color{gray}\textbar\enskip}{0cm}{} % Formats subsection titles

\titleformat{\subsubsection}{\sffamily\color{rose}\bfseries}{\thesubsubsection\enskip\color{gray}\textbar\enskip}{0cm}{} % Formats subsubsection titles

% Formats captions
\DeclareCaptionFont{rose}{\color{rose}}
\captionsetup{labelfont={rose,bf}}
