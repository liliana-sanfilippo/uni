...
\newglossary*{vortrag}{Begriffe}
\makeglossaries
\loadglsentries{gloss}
\loadglsentries{vortragsgloss}
% QUOTES 
\usepackage{epigraph}
...
\newtcolorbox{tipp}[1][Tipp]{my box, #1}
...
\lhead{SoSe 2025}
\chead{}
\rhead{\fcolorbox{reds}{urgent}{
        \footnotesize\bfseries{\makebox[22em]
        {\color{white} K-mer basierte Algorithmen in der Bioinformatik}}}%
}
