...
\section{ILP-Based KGR Methods}\label{sec:ilp-based-kgr-methods}
...
\begin{mytable}
    \begin{tabular}{llccc}
        \textbf{Category} & \textbf{Method} & \gls{mrr} & \textbf{Hit@1} & \gls{Hit@10} \\

        ILP-Based & AnyBURL & 0.310 & 0.233 & -- \\
        ILP-Based & SAFRAN & 0.389 & 0.298 & 0.537 \\
    ...
    \end{tabular}
    \caption{Performance comparison of representative KGR methods.}
...
\begin{mytable}
    \begin{tabular}{lcccc}
        ...
        Medium--{\color{green}High} &
            {\color{green}High} \\
    \end{tabular}
    \caption{Comparison of logical rule-based KGR methods.}
...
\begin{enumerate}
    ...
    \item Evolution:
    \begin{itemize}
        \item From interpretable but inefficient (ILP)
