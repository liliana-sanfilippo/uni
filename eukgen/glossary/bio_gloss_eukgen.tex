...
\newglossaryentry{reportergen}{
    name={Reportergen},
    description={kodiert für ein Protein, das experimentell (relativ)
    leicht nachweisbar ist und bei dessen Nachweis sich die Signale
    deutlich von Hintergrundsignalen abheben},
    type=defi
}

\newglossaryentry{translationale_fusion}{
    name={Translationale Fusion},
    description={td},
    type=defi
}

\newglossaryentry{marker_2}{
    name={Genetische Marker},
    description={Variantes Allel, das vererbar und (leicht) detektierbar ist},
    type=defi
}

\newglossaryentry{caps}{
    name={CAPS},
    first={Cleaved Amplified Polymorphic Sequence (CAPS)},
    description={Scchnittstelle für Restriktionsenzym in PCR-Amplifikat und genettischer Marker},
    type=defi
}

\newglossaryentry{gus}{
    name={GUS},
    first={β-Glucuronidase (GUS)},
    description={td},
    type=defi
}

\newglossaryentry{transkriptionale_fusion}{
    name={Transkriptionale Fusion},
    description={td},
    type=defi
}

\newglossaryentry{genexpressionsanalyse}{
    name={Genexpressionsanalyse},
    description={Untersuchung der Umsetzung
    der genetischen Information (kodiert in der DNA) mit molekularbiologischen
    und biochemischen Methoden},
    type=defi
}

\newglossaryentry{sgrna}{
    name={sgRNA},
    first={sgRNA (single guide RNA)},
    description={crRNA und tracrRNA mit Linker zu einer RNA verbunden},
    type=defi
}
%https://www.crispr-whisper.de/glossar/sgrna/
