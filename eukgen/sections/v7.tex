...
% BIS F 7 Wdh
\untit{Kapitel 8 in Lewin's Genes II}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\linewidth]{images/Feinbau_der_Chromosomen}
        \caption{}\label{fig:Feinbau_der_Chromosomen}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[width=\linewidth]{images/Histones}
        \caption{}\label{fig:Histones}
    \end{subfigure}
\end{figure}
% Feinbau der Chromosomen.svg
...
\subsection{Principles of Chromatin Looping (TODO)}\label{subsec:principles-of-chromatin-looping}
% TODO F 26 - 28

\subsection{Histon - Modifikationen (TODO)}\label{subsec:histon---modifikationen}
% TODO F 31 - 32

\kfrage{epigenetischeModifikationen}

\subsection{Der ``Histon - Code'' (TODO)}\label{subsec:der-``histon---code''}
% TODO F 33 - 34
...
\subsection*{Von Euchromatin zu Heterochromatin (TODO)}
% TODO F 49-50
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/rna_inteference}
    \caption{}\label{fig:rna_inteference}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/mi_si_biogenese}
    \caption{Vergleich der Biogenese von miRNA (in Tieren) und siRNA}\label{fig:mi_si_biogenese}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/mi_biogenese_pflanzen_tiere}
    \caption{Vergleich der Biogenese von miRNA in Tieren und Pflanzen}\label{fig:mi_biogenese_pflanzen_tiere}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/Thessaloniki_RISC}
    \caption{Alternative Darstellung der miRNA Biogenese und anschließender Funktion. Bild adaptiert von \href{https://2021.igem.org/Team:Thessaloniki/Description}{iGEM Thessaloniki 2021}.}
    \label{fig:Thessaloniki_RISC}
\end{figure}


\subsubsection{Weitere Typen von miRNA (TODO)}
% TODO F 77 - 78
...
\subsubsection{Vorhersage von miRNA targets (TODO)}
% TODO F 80

\subsubsection{Experimentelle Analyse
der miRNA-Funktionen (TODO)}
% TODO F 81 - 82
...
\subsubsection{Endogene Rolle der miRNAs (TODO)}

% % % %
% TODO biöld Folie 71 + 75
