...
\section{DNA-Verpackung}

\subsection{Histone und Nukleosomen}
\defin{histon}
Fünf Klassen:
...
\begin{table}[H]
    ...
    \begin{tabular}{ll}
        ...
        H4                   & 102
    \end{tabular}
    \caption{Protein-Bestandteile des Nukleosoms}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        Chromatin-Schleifen & $\sim$250        & ca. 100.000
    \end{tabular}
    \caption{Hierarchie von DNA-Windungen}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Packungsdichte von Chromatin}
\end{table}
...
\subsection{Principles of Chromatin Looping}
% TODO F 26 - 28

\subsection{Histon - Modifikationen}
% TODO F 31 - 32

\subsection{Der ``Histon - Code''}
% TODO F 33 - 34

% TODO F 35 ChIP - Chromatin immune precipitation

\subsection{Nucleosome (re)assembly}
% TODO F 40, 43
...
Oligonukleotide. Im Unterschied zum Knockout bleibt Restexpression
...
\subsection{Sekundärstrukturen}
% TODO F 70

\subsection{Biogenese und Vergleich miRNAs - siRNAs}
% TODO F 71 - 76
\defin{primimrna}
\defin{premimrna}
\defin{mirnaduplex}
