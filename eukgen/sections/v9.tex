...
\begin{figure}[H]
    ...
    \caption{Richtige Darstellung eines Antikörpers. }\label{fig:antibody}
\end{figure}
Bild von \href{https://bio.libretexts.org/Bookshelves/Microbiology/Microbiology_(Boundless)/11%3A_Immunology/11.07%3A_Antibodies/11.7B%3A_Antibody_Genes_and_Diversity}{LibreTexts}
