...
\section{Untersuchung der Genexpression mittels RT-PCR}\label{sec:untersuchung-der-genexpression-mittels-rt-pcr}

\subsection{Einführung}\label{subsec:einfuhrung3}
...
\subsection{Photometrische Messung der RNA-Konzentration}\label{subsec:photometrische-messung-der-rna-konzentration}~\ausschnitt{Die Konzentration einer DNA- oder RNA-Lösung wird üblicherweise
...
folgenden Verhältnisses berechnet werden:
    \begin{itemize}
        ...
        \item $\mathrm{OD}_{260} = 1$ entspricht $40\,\mu\mathrm{g/mL}$ \gls{rna}
...
ein Indikator für weitere Verunreinigungen z.B. mit Polysacchariden ist.}{folien32}
